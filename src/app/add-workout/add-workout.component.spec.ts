...
export class AddWorkoutComponent {
  // Explicitly declare minutes as either number or null
  workout = { name: '', type: '', minutes: null as number | null };
  message: string = '';
  ...
  addWorkout() {
    if (this.workout.name && this.workout.type && this.workout.minutes !== null) {
